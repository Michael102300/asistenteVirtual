...
def abrir_blocNotas():
    ...
    lupita.setProperty('voice', 'TTS_MS_ES-MX_SABINA_11.0')
    lupita.say('Estoy ista para escribir tu texto Esimio Impune')
    lupita.runAndWait()


def abrir_youtube():
    sub.call([r'C:/Users/jorge/Documents/venv/navegar.bat'])
    return None
